...
Topscorers:\n${topScorers.join("\n")}`;
    ...
    const systemPrompt = `Je bent de vriendelijke assistent van VVC Goes UK — het FC VVC JO11-1 team dat naar Londen gaat in 2026. Spelers: Wesley, Emersen, Alex, Syb, Thomas, Sepp, Deniz, Kayne, Tyren. Antwoord in het Nederlands, warm en bondig. Geen markdown.
